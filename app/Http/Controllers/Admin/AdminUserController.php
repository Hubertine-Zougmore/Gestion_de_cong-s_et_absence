    ...
    public function destroy($id)
{
    ...
    //     return redirect()->route('admin.utilisateurs.index')
    //                      ->with('error', 'Impossible de supprimer cet utilisateur car il a des demandes associées.');
    // }
    ...
    try {
        ...
        \Log::error('Erreur suppression utilisateur ' . $id . ': ' . $e->getMessage());
